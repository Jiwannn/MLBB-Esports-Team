        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              ...
              />
              <button className="px-4 py-2 md:px-4 md:py-2 bg-gradient-to-r from-yellow-500 to-yellow-300 text-black font-semibold rounded-lg sm:rounded-r-lg sm:rounded-l-none text-sm">
                Subscribe
              </button>
            </form>
          </div>
