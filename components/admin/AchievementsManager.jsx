...
import { Plus, Edit, Trash2, Upload, X, Trophy, Medal, Award } from 'lucide-react';
...
export default function AchievementsManager() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm({ title: '', description: '', icon: 'Trophy', image: '' });
      fetchAchievements();
    } catch (error) {
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold gold-text">Achievements</h2>
        <button
          onClick={() => {
            setEditingAchievement(null);
            setForm({ title: '', description: '', icon: 'Trophy', image: '' });
          ...
          {achievements.map((achievement) => {
            ...
            return (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="text-lg font-bold gold-text truncate">{achievement.title}</h3>
                  ...
                  <div className="flex space-x-1 mt-3">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center space-x-1 px-3 py-1.5 bg-blue-500/20 text-blue-400 rounded text-xs"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 flex items-center justify-center space-x-1 px-3 py-1.5 bg-red-500/20 text-red-400 rounded text-xs"
                    >
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 p-6 rounded-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {/* Icon Select */}
              <div>
                <label className="block text-sm silver-text mb-2">Icon</label>
                <select
                  value={form.icon}
              ...
              <div>
                <label className="block text-sm silver-text mb-2">Image (Optional)</label>
                {form.image ? (
                  <div className="relative">
                    <img src={form.image} alt="Achievement" className="w-full h-32 object-cover rounded-lg" />
                    <button
                      type="button"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-black border border-gray-700 rounded-lg text-white"
                  placeholder="e.g., MLBB Champion 2024"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="3"
                  className="w-full px-4 py-2 bg-black border border-gray-700 rounded-lg text-white"
                  placeholder="e.g., Won the national championship"
                  required
                />
              </div>
