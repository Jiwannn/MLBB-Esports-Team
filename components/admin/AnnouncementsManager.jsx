          ...
          {announcements.map((announcement) => (
            ...
            >
              ...
              <div className="relative w-full h-36 md:h-40">
                ...
                <span className="absolute top-2 right-2 px-2 py-1 rounded-full text-xs bg-black/50 text-gray-300">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-400 text-xs">{announcement.content}</p>
          ...
          <div className="bg-gray-900 p-6 rounded-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  >
                    {uploading ? (
                      ...
                      <>
                        ...
                        <span className="text-gray-400 text-sm">Upload Banner Image</span>
                      </>
                    )}
                  </div>
                )}
              ...
              <div>
                ...
                <textarea value={form.content} onChange={(e) => setForm({ ...form, content: e.target.value })} rows="4" className="w-full px-4 py-2 bg-black border border-gray-700 rounded-lg text-white" required />
              </div>
